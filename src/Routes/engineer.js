...
Router.delete('/delete/:id', controller.deleteEngineer);
...
Router.delete('/skill/delete', jwtAuth.authEngineerCRUD, controller.deleteEngineerSkill);
...
Router.delete('/showcase/delete', jwtAuth.authEngineerCRUD, controller.deleteEngineerShowcase);
